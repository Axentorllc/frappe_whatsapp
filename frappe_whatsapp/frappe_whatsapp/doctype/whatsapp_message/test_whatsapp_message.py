...
class TestWhatsAppMessage(IntegrationTestCase):
    ...
    def setUp(self):
        # Set password and claim defaults — these tests verify auto-selection of default account.
        # db.set_value bypasses on_update so we clear globally then claim ours.
